...
- `from`: (optional) From address, defaults to "WODsApp <noreply@wodsapp.online>"
  
**Note**: Make sure to add and verify `wodsapp.online` at https://resend.com/domains before using this function.
